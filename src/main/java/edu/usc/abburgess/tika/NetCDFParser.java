...
public class NetCDFParser extends AbstractParser {
    ...
    public void parse(InputStream stream, ContentHandler handler,
        ...
        try {
            ...
            System.err.println(ncFile.getFileTypeVersion());
           ...
           xhtml.startDocument();
		   		...
		   		xhtml.characters("dimensionsssss:");
				xhtml.newline();
			
				for (Dimension dim : ncFile.getDimensions()){
                	xhtml.characters(dim.getFullName()); 
                	xhtml.characters(" = ");
				...
				xhtml.newline();
				xhtml.characters("variablesssssss");
